...
public class FixedRocketController_Lys : MonoBehaviour
{
    [Header("Positions")]
    ...
    void Update()
    {
        ...
        if (triggerValue && !oldTriggerValue)
        {
            ...
            bullet.GetComponent<Rigidbody>().velocity = bullet.transform.forward * GameManager_Lys.instance.GetRocketBulletSpeed();
        }
