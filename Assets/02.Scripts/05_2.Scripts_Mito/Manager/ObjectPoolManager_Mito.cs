...
public class ObjectPoolManager_Mito : MonoBehaviour
{
    [System.Serializable]
    ...
    public static ObjectPoolManager_Mito instance;
    ...
    private void Init()
    {
        ...
        for (int idx = 0; idx < objectInfos.Length; idx++)
        {
            ...
            for (int i = 0; i < objectInfos[idx].count; i++)
            {
                ...
                PoolAble_Mito poolAbleGo = CreatePooledItem().GetComponent<PoolAble_Mito>();
    ...
    private GameObject CreatePooledItem()
    {
        ...
        poolGo.GetComponent<PoolAble_Mito>().Pool = ojbectPoolDic[objectName];
        return poolGo;
    }
